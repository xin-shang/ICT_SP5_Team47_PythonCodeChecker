...
public class ChooseQuestionComponent extends Box{
	...
	public static JTable chooseQuestionTable;
        ...
        // 创建集合 操作集合比操作数组容易
	private static Vector titlesChooseQuestion_Table = new Vector(); // 存储标题
	...
	public void Button_Item_ShowQuestionButton(JButton button) {
		button.addActionListener(new ActionListener() {
				...
				StudentWorkingComponent.setQuestionString(WriteAndRead.readQuestion(getValueAt_Table(getSelectedRow(), 1)));
