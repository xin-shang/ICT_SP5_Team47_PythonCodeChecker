...
public class PythonCodeChackerPage {
	...
	public void init() {
		...
		Button_Run_Listener(button_Submit);
	...
	private void Button_Run_Listener (JButton button) {
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String try_print = WAR.readText("./java/src/txt/user_output.txt");
					
					System.out.print(try_print);
					area_2.setText(try_print);
				} catch (IOException e1) {
					e1.printStackTrace();
				}
