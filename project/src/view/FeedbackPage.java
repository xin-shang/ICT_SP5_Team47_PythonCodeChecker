...
public class FeedbackPage extends JDialog {
	...
	private boolean syntaxErrorStatus = false; // A variable to store whether there are syntax error after running the
												// code
	private String runResultMessage = ""; // To store the output that comes from running the program, either error
											// message or output
