...
public class FeedbackPage extends JDialog{
    ...
    public void addComponents(){
        ...
        studentAnswerScrollPane = new JScrollPane(studentAnswerScrollPane);
        studentAnswerScrollPane.setPreferredSize(new DimensionUIResource(this.getWidth(), (int)(this.getHeight()* 0.65)));
        ...
        suggestedAnswerScrollPane = new JScrollPane(suggestedAnswerScrollPane);
        suggestedAnswerScrollPane.setPreferredSize(new DimensionUIResource(this.getWidth(), (int)(this.getHeight()* 0.65)));
